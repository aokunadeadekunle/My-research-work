                        ...
                        {//open if count
                            while ($row=mysql_fetch_object($result))
                                ...
                                {   // open if 2
                                    ...
                                    $insertPacket=mysql_query("insert into packet (sourceIp, subject, textarea, spamicity, dateTime) 
                                    values ('$sourceIp', '$subject', '$textarea', '$spamicity', '$dateTime')") or 
