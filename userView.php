...
<table width="1000" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr>
    <td colspan="9"><div align="center" class="style1">VIEW USER(S)</div></td>
  </tr>
  <tr bgcolor="#FFFFCC">
    <td width="55"><span class="style16">S/NO</span></td>
    <td width="250"><span class="style16">NAME(S)</span></td>
    <td width="200"><span class="style16">EMAIL ADDRESS </span></td>
    <td width="121"><span class="style16">PHONE</span></td>
    <td width="110"><span class="style16">USER ID</span></td>
    <td width="110"><span class="style16">PASSWORD</span></td>
